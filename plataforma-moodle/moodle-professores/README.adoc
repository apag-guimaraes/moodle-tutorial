...
video::nm7Zg9PpMw8[youtube,width=640,height=480]
...
video::pg0U40bSpw4[youtube,width=640,height=480]
//video::-dXCrY-diFg[youtube,width=640,height=480]

=== Visualizar as tarefas enviadas e fazer correções no Moodle

A plataforma Moodle oferece recursos bastante legais e funcionais que permite o docente fazer correções das tarefas enviadas pelos estudantes. 

video::VCEo36428wU[youtube,width=640,height=480]
...
=== Importando arquivos GIFT para criação de questões

O vídeo aborda em como usar a ferremanetas de IA generativa para criação ou conversão de arquivos em formato GIFT para importação de questões na plataforma MOODLE.

video::u5-5cEHncw0[youtube,width=640,height=480]
